...
CREATE TABLE record (
    ...
    recorded_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Timestamp when the measurement was recorded at the location',
...
VALUES ('Murray River', 7.0, 1.21, 20.5, '2025-02-01 12:00:00'),
       ('Lake Argyle', 7.5, 1.09, 21.0, '2025-02-01 12:00:00'),
       ('Derwent River', 6.5, 1.50, 19.5, '2025-02-01 12:00:00'),
       ('Murray River', 7.2, 1.29, 20.7, '2025-02-02 00:00:00'),
       ('Lake Argyle', 7.6, 1.11, 21.2, '2025-02-02 00:00:00'),
       ('Derwent River', 6.3, 1.55, 19.3, '2025-02-02 00:00:00');
