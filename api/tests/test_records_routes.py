...
class WaterQualityTestCase(unittest.TestCase):
    ...
    def test_get_empty_records(self):
        """Test GET /records returns an empty list when no records exist."""
    ...
    def test_add_record(self):
        """Test POST /records creates a new record."""
        record_data = {
    ...
    def test_get_record(self):
        """Test GET /records/<id> returns the correct record."""
    ...
    def test_get_record_not_found(self):
        """Test GET /records/<id> for a non-existent record returns 404."""
        response = self.client.get("/records/999")
        self.assertEqual(response.status_code, 404)

    def test_delete_record(self):
        """Test DELETE /records/<id> deletes the record."""
    ...
    def test_delete_record_not_found(self):
        """Test DELETE /records/<id> for a non-existent record returns 404."""
